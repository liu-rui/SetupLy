...
function isValidDotNet4OS()
	SetupData.WriteToLogFile("Info\t.NET 4.5 Module: Entering compatible OS detection.\r\n",true);
...
Click OK to abort the setup, or Cancel to continue with the application install.]];
	...
	local strExtractInstallerToPath = strRuntimeSupportFolder.."\\NDP451-KB2858728-x86-x64-AllOS-ENU.exe";
	...
	SetupData.WriteToLogFile("Success\t.NET 4.5 Module: Installation script started.\r\n", true);
